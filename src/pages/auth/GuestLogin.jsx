    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (user && user.title === 'Guest Viewer') {
                ...
                // If it's an admin account trying to log in via guest portal
                await logout();
                setLocalError('This login portal is for Guests only. Admins must use the Admin Login.');
            }
        } catch (error) {
            ...
            <motion.div
                ...
                <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
                    <div style={{
                        ...
                        <User style={{ height: '2.25rem', width: '2.25rem', color: '#38bdf8' }} />
                    </div>
                    <h1 style={{ fontSize: '2rem', fontWeight: 800, color: '#f8fafc', letterSpacing: '-0.025em', margin: 0, textShadow: '0 2px 4px rgba(0,0,0,0.3)' }}>Guest Login</h1>
                    <p style={{ color: '#cbd5e1', marginTop: '0.5rem', fontWeight: 500 }}>Sign in to view live presentations</p>
                </div>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                    ...
                    >
                        {loading ? 'Authenticating...' : 'Sign In as Guest'}
                    </motion.button>
                </form>
            </motion.div>
        </div>
